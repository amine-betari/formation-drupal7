 ...
 */
function bookdev_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['bookdev_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('bookdev sample setting'),
  '#default_value' => theme_get_setting('bookdev_example'),
